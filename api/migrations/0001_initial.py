...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Plan',
            fields=[
                ('id', models.CharField(choices=[('FREE', 'Free'), ('DIAMOND', 'Diamond'), ('IMPERIAL', 'Imperial')], max_length=20, primary_key=True, serialize=False)),
                ...
                ('cap_percent', models.DecimalField(decimal_places=2, max_digits=5)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('method', models.CharField(choices=[('USDT', 'USDT – BEP20'), ('PIX', 'PIX')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('YIELD', 'Rendimento'), ('REFERRAL', 'Indicação'), ('BONUS', 'Bônus'), ('CASHBACK', 'Cashback'), ('REFUND', 'Estorno')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tx_type', models.CharField(choices=[('TRANSFER', 'Token transfer'), ('CONTRACT', 'Contract call')], max_length=10)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='onchain_txs', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Investment',
            fields=[
                ...
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='investments', to='api.plan')),
            ],
        ),
    ]
