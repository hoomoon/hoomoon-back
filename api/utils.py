...
class BusinessRulesValidator:
    ...
    def validate_deposit_amount(amount: float) -> tuple[bool, str]:
        ...
        """
        min_amount = settings.BUSINESS_RULES.get('MIN_DEPOSIT_AMOUNT', 10.0)
        max_amount = settings.BUSINESS_RULES.get('MAX_DEPOSIT_AMOUNT', 50000.0)
    ...
    def validate_withdrawal_amount(amount: float) -> tuple[bool, str]:
        ...
        """
        min_amount = settings.BUSINESS_RULES.get('MIN_WITHDRAWAL_AMOUNT', 50.0)
    ...
    def calculate_referral_bonus(amount: float) -> float:
        ...
        """
        bonus_percent = settings.BUSINESS_RULES.get('REFERRAL_BONUS_PERCENT', 5.0)
    ...
    def calculate_withdrawal_fee(amount: float) -> float:
        ...
        """
        fee_percent = settings.BUSINESS_RULES.get('WITHDRAWAL_FEE_PERCENT', 2.0)
    ...
    def get_system_info() -> Dict[str, Any]:
        ...
        return {
            ...
            "features": {
                ...
                for feature in settings.FEATURES.keys()
            },
            "business_rules": {
                "min_deposit": settings.BUSINESS_RULES.get('MIN_DEPOSIT_AMOUNT'),
                "max_deposit": settings.BUSINESS_RULES.get('MAX_DEPOSIT_AMOUNT'),
                "min_withdrawal": settings.BUSINESS_RULES.get('MIN_WITHDRAWAL_AMOUNT'),
                "referral_bonus_percent": settings.BUSINESS_RULES.get('REFERRAL_BONUS_PERCENT'),
                "withdrawal_fee_percent": settings.BUSINESS_RULES.get('WITHDRAWAL_FEE_PERCENT'),
                "default_currency": settings.BUSINESS_RULES.get('DEFAULT_CURRENCY')
            }
        }
